...
var App = {
		...
		$(window).scroll(function() {
			...
			if(windowWidth > 768) {
				...
				if($('.testimonial').is_on_screen()) {
					...
					yPos = ($(window).scrollTop() - ($('.testimonial').offset().top + $('.testimonial').outerHeight())) * 0.001;
					coords = '50% '+ yPos + 'px';
	...
	create_info: function() {
		...
		boxText.style.cssText = "color:#fff;font-family: is;font-size: 11px;text-align: right;";
		/*jshint multistr: true*/
		boxText.innerHTML = "\
			<div class='marker-label'>\
				تهران، سعادت آباد<br>\
				بلوار دریا، کوچه مانی<br>\
				کد پستی : 3155956799<br>\
				+تلفن : 982122223500<br>\
				</div>\
			";
